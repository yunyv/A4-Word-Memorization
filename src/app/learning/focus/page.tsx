...
import { Maximize2, Volume2, Shuffle, LogOut } from 'lucide-react';
...
function FocusLearningContent() {
            ...
            .catch(error => {
              if (!abortController.signal.aborted) {
                ...
                if (error.name === 'NotAllowedError') {
                  ...
                  // 如果是用户交互触发的播放，可以显示提示
                  if (userInteraction) {
                    console.log('即使在用户交互后也被阻止，可能需要进一步的用户操作');
                  }
                } else if (error.name === 'AbortError') {
                  console.log('音频播放被中断:', error);
  ...
  }, [settings.uiSettings.autoPlayAudio, hasUserInteraction]);
